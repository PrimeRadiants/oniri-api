...
public class ReaderNoventListGetRestControllerTest {
    ...
    public void NoventListReturns401WithNonExistingUser() throws Exception {
        ...
        MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.get("/rest/api/novent/list").with(httpBasic(UserTestData.USER_USERNAME + "1", UserTestData.USER_PASSWORD)).secure(true);
        this.mockMvc.perform(builder)
                    .andExpect(unauthorized);
    }
    ...
    public void NoventListReturns302WhenNotSecured() throws Exception {
        ...
        MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.get("/rest/api/novent/list").with(httpBasic(UserTestData.USER_USERNAME, UserTestData.USER_PASSWORD)).secure(false);
        this.mockMvc.perform(builder)
    ...
    public void NoventListReturnsOkWhenLoggedInWithExistingUser() throws Exception {
        ...
        MockHttpServletRequestBuilder builder = MockMvcRequestBuilders.get("/rest/api/novent/list").with(httpBasic(UserTestData.USER_USERNAME, UserTestData.USER_PASSWORD)).secure(true);
        this.mockMvc.perform(builder)
                    .andExpect(ok);
    }
